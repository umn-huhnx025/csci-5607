...
struct Pixel {
  ...
  // Constructor
  Pixel(Component r_ = 0, Component g_ = 0, Component b_ = 0,
        Component a_ = 255)
      : r(r_), g(g_), b(b_), a(a_) {}
  Pixel(uint8_t *data) : r(data[0]), g(data[1]), b(data[2]), a(data[3]) {}

  // Set
  void Set(Component r_, Component g_, Component b_, Component a_) {
    r = r_;
    g = g_;
    b = b_;
    a = a_;
  }
  void Set(Component r_, Component g_, Component b_) {
    r = r_;
    g = g_;
    b = b_;
  }
