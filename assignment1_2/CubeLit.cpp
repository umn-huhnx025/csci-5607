...
int main(int argc, char* argv[]) {
  ...
  float vertices[] = {
      ...
      -0.5f, -0.5f, -0.5f, 0.2f,  0.2f,  0.2f,  0.0f,  1.0f,  0.5f,  -0.5f,
      -0.5f, 0.2f,  0.2f,  0.2f,  1.0f,  1.0f,  0.5f,  -0.5f, 0.5f,  0.2f,
      0.2f,  0.2f,  1.0f,  0.0f,  0.5f,  -0.5f, 0.5f,  0.2f,  0.2f,  0.2f,
      1.0f,  0.0f,  -0.5f, -0.5f, 0.5f,  0.2f,  0.2f,  0.2f,  0.0f,  0.0f,
  ...
  glBufferData(GL_ARRAY_BUFFER, sizeof(normals), normals,
               GL_STATIC_DRAW);  // upload normals to vbo
